...
void ShowParams() {
  ...
  std::cout << "mbWriteKFsToFile: " << (int)params::stats::mbWriteKFsToFile
            << std::endl;
  ...
  cout << "miPlaceRecRateRate: " << params::timings::server::miPlaceRecRateRate
       << endl;
  cout << endl;
  cout << "++++++++++ Tracking ++++++++++" << endl;
  ...
  cout << "miMatchesInliersThres: " << params::tracking::miMatchesInliersThres
       << endl;
  cout << "mfThRefRatio: " << params::tracking::mfThRefRatio << endl;
  // Tracking Functions Inlier Thresholds
  std::cout << "miTrackWithRefKfInlierThresSearch: "
            << params::tracking::miTrackWithRefKfInlierThresSearch << std::endl;
  std::cout << "miTrackWithRefKfInlierThresOpt: "
            << params::tracking::miTrackWithRefKfInlierThresOpt << std::endl;
  std::cout << "miTrackWithMotionModelInlierThresSearch: "
            << params::tracking::miTrackWithMotionModelInlierThresSearch
            << std::endl;
  std::cout << "miTrackWithMotionModelInlierThresOpt: "
            << params::tracking::miTrackWithMotionModelInlierThresOpt
            << std::endl;
  std::cout << "miTrackLocalMapInlierThres: "
            << params::tracking::miTrackLocalMapInlierThres << std::endl;
  cout << endl;
  cout << "++++++++++ Mapping ++++++++++" << endl;
  ...
  cout << "mfPubPeriodicTime: " << params::comm::client::mfPubPeriodicTime
       << endl;
  cout << "miPubMapBufferSize: " << params::comm::client::miPubMapBufferSize
       << endl;
  cout << "miSubMapBufferSize: " << params::comm::client::miSubMapBufferSize
       << endl;
  ...
  cout << "mfPubPeriodicTime: " << params::comm::server::mfPubPeriodicTime
       << endl;
  cout << "miKfLimitToClient: " << params::comm::server::miKfLimitToClient
       << endl;
  cout << "miPubMapBufferSize: " << params::comm::server::miPubMapBufferSize
       << endl;
  cout << "miSubMapBufferSize: " << params::comm::server::miSubMapBufferSize
       << endl;
  ...
  cout << "miStartMapMatchingAfterKf: "
       << params::placerec::miStartMapMatchingAfterKf << endl;
  cout << "miCovisibilityConsistencyTh: "
       << params::placerec::miCovisibilityConsistencyTh << endl;
  cout << endl;
  cout << "++++++++++ Vis ++++++++++" << endl;
  ...
  cout << "mfMarkerSphereDiameter: " << params::vis::mfMarkerSphereDiameter
       << endl;
